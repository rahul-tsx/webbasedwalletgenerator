			...
			{isOpen && (
				<motion.div
					...
					<motion.div
						ref={modalRef}
						className={cn(
							'min-h-[50%] max-h-[90%] w-full md:max-w-[60%] 2xl:max-w-[50%] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden overflow-y-auto scrollbar-dark',
							className
						)}
						initial={{
							opacity: 0,
